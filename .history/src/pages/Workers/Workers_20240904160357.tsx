    ...
    <>
      <div className="flex h-screen">
        ...
        <div className="flex flex-col h-screen justify-between w-4/5">
          ...
          <TextInput className="h-11 w-48 rounded-l-[5px] rounded-r-none border border-solid border-gray-300" onChange={handleFilter} id="search" type="text" placeholder="..." required/>
