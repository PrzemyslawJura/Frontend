    ...
    <>
      <div className="flex h-screen">
        ...
        <div className="flex flex-col h-screen justify-between w-4/5">
          ...
          <Button className="h-[34px] w-14 rounded-r-[5px] rounded-l-none text-center flex items-center font-semibold" color="gray" onClick={toggleVisibilityFilters}>Filters</Button>
