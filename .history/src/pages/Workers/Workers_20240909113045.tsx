      ...
      <div className="flex h-screen">
        ...
        <div className="flex flex-col h-screen justify-between w-4/5">
          ...
          {isVisibleFilters && (
           ...
           <Filters/>
           <Button className="ml-5 h-[34px] w-14 rounded-r-[5px] rounded-l-none text-center flex items-center font-semibold" onClick={toggleVisibilityFilters}>Filter</Button>
           </div>
          )}
